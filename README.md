...
To evaluate `Vim-Ti` on ImageNet-1K, run:
```bash
python /home/albert/ml/Mambas/vim/Vim/vim/vim/main.py --eval --tome --resume /home/albert/ml/Mambas/vim/Vim/vim/ckpt/vim_s_midclstok_ft_81p6acc.pth --model vim_small_patch16_stride8_224_bimambav2_final_pool_mean_abs_pos_embed_with_midclstok_div2 --data-path /home/albert/ml/Mambas/ImageNet1k/ILSVRC/Data/CLS-LOC
```
