...
from tome.patch import test_mamba_patch
...
def get_args_parser():
    ...
    parser.add_argument('--test_tome_patch', action='store_true', help='Sets using test_tome_patch to true (uses the test patch funcion of tome)')
...
def main(args):
    ...
    if args.resume:
        ...
        if args.test_tome_patch:
            test_mamba_patch.apply_patch(model_without_ddp)
